...
public class UserController {
	...
	public String join_next(
			@Valid @ModelAttribute("userVO") UserVO userVO,BindingResult result, String error, Model model, SessionStatus sessionStatus) {
...
//		}
		if(userVO.getKey().equals(userVO.getKey_ok())) {
			...
			model.addAttribute("error",error);
			log.debug("인증키가 다릅니다.");
			return "redirect:/user/join_next?error";
		}
