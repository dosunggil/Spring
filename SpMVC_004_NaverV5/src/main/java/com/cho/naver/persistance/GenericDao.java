...
/*
 * SpringMVC 패턴의 프로젝트에서는 DBMS 와 연동을 할 때는
 * 기능별로 최소환의 CRUD 를 구현해야 한다.
 ...
 * 
 * 그래서 Service, Dao interface 를 구현할 때 공통으로 사용할
 ...
 * 지정할 수 있도록 Generic type 의 interface로 구현해 놓는다.
 * 
 * 여기에서 선언하는 Generic type 이란
 * 아직 구현되지 않은 임의의 type 이며
 * 이 interface 를 상속받아 구현할 때 비로소 구체화된다.
 */
