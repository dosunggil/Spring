...
public class BookControllerV2 {
	...
	public BookControllerV2(BookService book, BuyBooksService buy) {
...
//		}
	...
	public String insert2(BookVO vo, HttpSession session, Model model) {
		log.debug("도서정보 : " + vo.toString());
		UserVO userVO = (UserVO) session.getAttribute("USER");
		if(userVO ==null) {
			model.addAttribute("error","LOGIN_NEED");
		...
		int ret = buyService.insert(userVO, vo);
