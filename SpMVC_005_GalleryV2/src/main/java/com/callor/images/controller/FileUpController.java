...
public class FileUpController {
	...
	/*
	 * MultipartHttpServletRequest 여러개의 파일을 동시에 업로드할 때 파일들의 정보를 동시에 수신하는 용도의 도구
	 */
	@RequestMapping(value = "fileups", method = RequestMethod.GET)
	public String upFiles(@ModelAttribute("bbsVO22") BBsVO bbsVO,   Model model) {

		return null;
	}

	@RequestMapping(value = "fileups", method = RequestMethod.POST)
	public String upFiles(@ModelAttribute("bbsVO22") BBsVO bbsVO, MultipartHttpServletRequest mFiles, Model model) {
