...
public class NaverServiceImpl implements NaverService {
	...
	/*
	 * 카테고리와 search 에 담긴 값을 전달받아서 Naver 에 요청할 QueryString 을 생성하는 method
	 */
	public String queryString(String cat, String search) {
		...
		if (cat.equals("NEWS")) {
			querySting = NaverConfig.NAVER_NEWS_URL;
		} else if (cat.equals("MOIVE")) {
			querySting = NaverConfig.NAVER_MOVIE_URL;
		}
